...
public class UartService extends Service {
    ...
    // String mac = "D8:75:DF:A4:10:F9";
    // 蓝牙地址
    public static String deviceAdd = "D8:75:DF:A4:10:F9";
    // 萌牙名称
    public static String deviceName = "neiyi2";
    ...
    public final static String ACTION_GATT_CONNECTED = "com.nordicsemi.nrfUART.ACTION_GATT_CONNECTEDs";
    public final static String ACTION_GATT_DISCONNECTED = "com.nordicsemi.nrfUART.ACTION_GATT_DISCONNECTEDs";
    public final static String ACTION_GATT_SERVICES_DISCOVERED = "com.nordicsemi.nrfUART.ACTION_GATT_SERVICES_DISCOVEREDs";
    public final static String ACTION_DATA_AVAILABLE = "com.nordicsemi.nrfUART.ACTION_DATA_AVAILABLEs";
    public final static String EXTRA_DATA = "com.nordicsemi.nrfUART.EXTRA_DATAs";
    public final static String DEVICE_DOES_NOT_SUPPORT_UART = "com.nordicsemi.nrfUART.DEVICE_DOES_NOT_SUPPORT_UARTs";
    ...
    private boolean getEcgDataFromArray(byte[] txValue, short[] ecgVal) {
        short x = 0, y = 0;
        x = (short) (txValue[0] & 0xff);

        if (x != 0xff)
            return false;

        x = (short) (txValue[1] & 0xff);

        if (x != 0xa1)
            return false;

        x = (short) (txValue[2] & 0xff);

        y = (short) (txValue[3] & 0xff);
    ...
    public void enableTXNotification() {
        ...
        if (RxService == null) {
            showMessage("Rx service not found! enableTXNotification");
    ...
    public void writeRXCharacteristic(byte[] value) {
        ...
        if (RxService == null) {
            ...
            System.out.println("writeRXCharacteristic");
            broadcastUpdate(DEVICE_DOES_NOT_SUPPORT_UART);
            return;
        }
        ...
        // int t = (int)(value[s] & 0xff);
        // RxChar.setValue(t,BluetoothGattCharacteristic.FORMAT_UINT8,s);
        // }
