package com.rotex.rotexemg.BubbleText;
...
/**
 * Created by QingWuyong on 2016/11/25.
 */
...
public class BubbleView extends RelativeLayout implements Runnable {
    ...
    public void setCurThemeStyle(int textColor) {
        ...
        int darkColor = ContextCompat.getColor(mContext,R.color.bubbleView_dark_text_color);
        int lightColor = ContextCompat.getColor(mContext,R.color.bubbleView_light_text_color);
