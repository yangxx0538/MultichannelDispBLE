package com.rotex.rotexemg.socket;
...
public abstract class TcpServer implements Runnable {
    ...
    public List<SocketTransceiver> clients = new ArrayList<SocketTransceiver>();
    ...
    private void startClient(final Socket socket) {
        SocketTransceiver client = new SocketTransceiver(socket) {
            ...
            public void onDisconnect(InetAddress addr) {
                Log.e("aaaaaaaddddddd", "11111111111sssssssssss22222222222ddd");
                clients.remove(this);
